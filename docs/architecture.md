...
- **personal** — Personal Productivity (overtime+reduction with start/end times, vacation, sick days, people, annual events, projects, 3-level todos with recurrence; SQLite)
...
| personal | `PERSONAL_DB_PATH`, `PERSONAL_TZ` (both optional) | N/A (local SQLite) |
