...
- Sonderfaelle: cloudflare (Proxy), aws-docs (Proxy), drawio (Proxy), github (Proxy zu offiziellem GitHub-MCP), aggregator (Proxy), memory (externes Binary), personal (`modernc.org/sqlite`), aws (`aws-sdk-go-v2`)
